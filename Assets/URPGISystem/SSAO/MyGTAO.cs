...
namespace NewVision.SSAO
{
    ...
    public class MyGTAO : ScriptableRendererFeature
    {

        [SerializeField, HideInInspector] private Shader m_Shader = null;
        [SerializeField] private SSAOSettings m_Settings = new SSAOSettings();

        private Material m_Material;

        private const string k_ShaderName = "Hidden/Universal Render Pipeline/GTAO";
        ...
        private class SSAOPass : ScriptableRenderPass
        {
            ...
            private SSAOSettings m_CurrentSettings;
            ...
            internal bool Setup(SSAOSettings featureSettings, ScriptableRenderer renderer, Material material)
            {
                m_Material = material;
                m_Renderer = renderer;
                m_CurrentSettings = featureSettings;

                SSAOSettings.DepthSource source;
                ...
                if (isRendererDeferred)
                {
                    ...
                    source = SSAOSettings.DepthSource.DepthNormals;
                ...
                switch(source)
                {
                    case SSAOSettings.DepthSource.Depth:
                        ConfigureInput(ScriptableRenderPassInput.Depth);
                        break;
                    case SSAOSettings.DepthSource.DepthNormals:
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                Vector4 ssaoParams = new Vector4(
                   ...
                   m_CurrentSettings.Radius,
                   1.0f / downsampleDivider,
                   m_CurrentSettings.SampleCount);
                ...
                float pixHeight = renderingData.cameraData.camera.pixelHeight;
                float pixWidth = renderingData.cameraData.camera.pixelWidth;
                Vector2 focalLen = new Vector2(invHalfTanFov * 
                ...
                SSAOSettings.DepthSource source = isRendererDeferred ?
                    SSAOSettings.DepthSource.DepthNormals : m_CurrentSettings.Source;


                if(source == SSAOSettings.DepthSource.Depth)
                {
                    switch(m_CurrentSettings.NormalSamples)
                    {
                        case SSAOSettings.NormalQuality.Low:
                            ...
                            break;
                        case SSAOSettings.NormalQuality.Medium:
                            ...
                            CoreUtils.SetKeyword(m_Material, k_NormalReconstructionHighKeyword, false);
                            break;
                        case SSAOSettings.NormalQuality.High:
                            CoreUtils.SetKeyword(m_Material, k_NormalReconstructionLowKeyword, false);
                            CoreUtils.SetKeyword(m_Material, k_NormalReconstructionMediumKeyword, false);
