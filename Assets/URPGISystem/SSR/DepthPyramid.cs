...
namespace NewVision.SSR
{
    public class DepthPyramid : ScriptableRendererFeature
    {
        ...
        class DepthPyramidPass : ScriptableRenderPass
        {
            ...
            {
                int width = (int)(renderingData.cameraData.cameraTargetDescriptor.width * GlobalMySSRSettings.GlobalResolutionScale);
                int height = (int)(renderingData.cameraData.cameraTargetDescriptor.height * GlobalMySSRSettings.GlobalResolutionScale);
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                float actualWidth = renderingData.cameraData.cameraTargetDescriptor.width * GlobalMySSRSettings.GlobalResolutionScale;
                float actualHeight = renderingData.cameraData.cameraTargetDescriptor.height * GlobalMySSRSettings.GlobalResolutionScale;
